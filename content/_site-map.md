...
| 頁面 | MD 檔案 | 摘要 | 狀態 |
|------|---------|------|------|
| **首頁** | content/index.md | Botrun 簡介、核心特點（多代理/知識庫/MCP/多模型/安全）、成功案例 6 則、獲獎、定價試用、聯絡 | ✅ Final MD 完成 |
| **功能總覽** | content/features/index.md | 功能模組完整說明 + 未來功能 | ✅ Final MD 完成 |
